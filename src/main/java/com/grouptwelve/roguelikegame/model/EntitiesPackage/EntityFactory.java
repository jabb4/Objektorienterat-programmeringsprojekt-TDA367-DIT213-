...
public class EntityFactory {
    ...
    private final HashMap<Entities,Entity> entityRegistry = new HashMap<>();

    public void registerEntity(Entities name, Entity entity){
        entityRegistry.put(name,entity);
    }

    public Entity createEntity(Entities name, double x, double y){
